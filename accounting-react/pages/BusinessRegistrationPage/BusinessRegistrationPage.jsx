...
const BusinessRegistrationPage = () => {
	const businessServicesData = {
		heroImage: 'https://ibcph.com/accounting-react/images/bg/building.jpg',
		...
		cardData: [
			{
				src: 'https://ibcph.com/accounting-react/images/stock/dti.jpg',
			...
			{
				src: 'https://ibcph.com/accounting-react/images/stock/sec.jpg',
			...
			{
				src: 'https://ibcph.com/accounting-react/images/stock/bir.jpg',
