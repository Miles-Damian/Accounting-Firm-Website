...
const router = createBrowserRouter([
    ...
    {
        path: '/services/bookkeeping-and-accounting',
        element: <BookKeepingAndAccountingServices />
    },
    {
        path: '/services/tax-and-regulatory-compliance',
        element: <TaxAndRegulationServicesPage />
    },
    {
        path: '/services/payroll-outsourced',
        element: <PayrollOutsourcedServicesPage />
    },
    {
        path: '/services/bir-transactions',
        element: <BirOneTImeTransactionServicesPage />
    },
    {
        path: '/services/specialized-registration',
        element: <SpecializedRegistrationServicesPage />
    },
    {
