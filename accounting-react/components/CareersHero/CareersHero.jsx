const CareersHero = () => {
	return (
		<section id="careers-hero" className="flex flex-col p-4 gap-4 md:flex-row md:h-[calc(100vh-4rem)] max-w-[1400px] md:mx-auto md:items-center lg:gap-4 lg:py-10 xl:py-18 mt-25">
			...
			<div className="flex-1 w-full h-full">
				<img src="https://ibcph.com/accounting-react/images/stock/handshake.jpg" alt="Handshake" className="object-cover w-full h-full rounded-xl" />
			</div>
		</section>
	);
};
