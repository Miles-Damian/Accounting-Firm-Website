...
const BusinessRegistrationPage = () => {
	const businessServicesData = {
		heroImage: 'https://ibcph.com/images/bg/building.jpg',
		...
		cardData: [
			{
				src: 'https://ibcph.com/images/stock/dti.jpg',
			...
			{
				src: 'https://ibcph.com/images/stock/sec.jpg',
			...
			{
				src: 'https://ibcph.com/images/stock/bir.jpg',
