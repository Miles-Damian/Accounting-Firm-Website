...
const Footer = () => {
	...
	return (
		...
		>
			<div
				className="grid grid-cols-1 gap-12 mx-auto text-center max-w-7xl sm:grid-cols-2 lg:grid-cols-4 font-montserrat lg:text-left">
				...
				>
					...
					<div className="flex items-center justify-center mb-4 space-x-5 lg:justify-start">
						...
						<div className="relative group">
							...
							<span
								className="absolute left-1/2 -translate-x-1/2 mt-2 w-max px-3 py-1 text-sm rounded-lg bg-[#004524] text-white opacity-0 group-hover:opacity-100 translate-y-1 group-hover:translate-y-0 transition-all duration-300">
               +63 939 927 0318
              </span>
						</div>
