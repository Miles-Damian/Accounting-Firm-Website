		...
		<section className="container px-6 py-20 mx-auto space-y-32 font-montserrat">
			...
			>
				...
				>
					...
					<p className="text-base leading-relaxed text-gray-600 md:text-lg">
						To empower entrepreneurs and businesses by delivering reliable, transparent, and value-driven
			...
			>
				...
				>
					...
					<p className="text-base leading-relaxed text-gray-600 md:text-lg">
						To become a leading business consultancy firm recognized for excellence, integrity, and
						innovation in supporting enterprise growth across the Philippines.
