      ...
      >
        ...
        <ul className="space-y-8 text-lg leading-relaxed text-gray-700">
          {clients.map((client, index) => (
            ...
            >
              {/* Icon */}
              <div className="flex items-center justify-center w-10 h-10 bg-[#00b894]/10 border-2 border-[#00b894] text-[#00b894] rounded-full shadow-sm transition-all duration-300 hover:bg-[#00b894] hover:text-white hover:scale-110">
