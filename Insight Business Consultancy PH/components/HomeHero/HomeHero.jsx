...
export default function HomeHero({
	...
	return (
		...
		>
			...
			{/* CONTENT */}
			<div
				className="relative mx-auto grid max-w-[1280px] grid-cols-1 items-center gap-10 px-6 py-14 sm:px-8 md:gap-10 md:py-20 lg:grid-cols-2 lg:py-24 xl:px-0">
				{/* LEFT COLUMN */}
				<motion.div
  ...
  INQUIRE NOW
				...
				>
					<div className="relative h-[420px] w-full select-none overflow-hidden sm:h-[480px] md:h-[520px]">
						...
						{/* Bullets */}
						<div
							className="absolute z-40 flex items-center gap-3 -translate-x-1/2 bottom-12 left-1/2 md:bottom-12">
							{images.map((_, i) => (
								<button
									key={i}
